 ...
 * Generated at: 2018-04-13 12:09:36 UTC
...
public final class storeTypeManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar storeType_searchForm;\r\n");
      out.write("\tvar editRow = undefined;\r\n");
      out.write("\tvar storeType_datagrid; \r\n");
      out.write("\t$(function() {\r\n");
      out.write("\t\tstoreType_searchForm = $('#storeType_searchForm').form();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\tstoreType_datagrid = $('#storeType_datagrid').datagrid({\r\n");
      out.write("\t\r\n");
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeType/list.action',\r\n");
      out.write("\t\t\ttitle : '仓库类型列表',\r\n");
      ...
      out.write("\t\t\t\t\t\tstoreType_add();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, '-', {\r\n");
      out.write("\t\t\t\t\ttext : '删除',\r\n");
      out.write("\t\t\t\t\ticonCls : 'icon-remove',\r\n");
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tstoreType_del();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, '-', {\r\n");
      out.write("\t\t\t\t\ttext : '修改',\r\n");
      out.write("\t\t\t\t\ticonCls : 'icon-edit',\r\n");
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tstoreType_edit();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, '-', {\r\n");
      out.write("\t\t\t\t\ttext : '保存',\r\n");
      out.write("\t\t\t\t\ticonCls : 'icon-save',\r\n");
      ...
      out.write("\t\t\t\t\t\t\tstoreType_datagrid.datagrid('endEdit', editRow);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\t \r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tstoreType_datagrid.datagrid('unselectAll');\r\n");
      out.write("\t\t\t\t\t\tstoreType_datagrid.datagrid.datagrid('rejectChanges');\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      out.write("\tfunction storeType_del(){\r\n");
      out.write("\t\tvar rows = storeType_datagrid.datagrid('getSelections');\r\n");
      out.write("\t\tvar ids = [];\r\n");
      ...
      out.write("\t\t            }\r\n");
      out.write("\t\t    \t$.messager.confirm('询问', '您确定要删除【' + rows.length + '】？个仓库类型', function(b) {\t\t\t\t \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t    \t\tif (b) {\r\n");
      out.write("\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeType/delete.action?ids='+ids+'',\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t            var index = storeType_datagrid.datagrid('getRowIndex',copyRows[i]);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            storeType_datagrid.datagrid('deleteRow',index); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     storeType_datagrid.datagrid('reload');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//storeType_datagrid.datagrid('clearSelections'); //清空选中的行 \r\n");
      ...
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction storeType_edit() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar rows = storeType_datagrid.datagrid('getSelections');\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$.messager.show({\r\n");
      out.write("\t\t\t\tmsg : '只能择一个仓库类型进行编辑！您已经选择了【' + names.join(',') + '】' + rows.length + '个仓库类型',\r\n");
      out.write("\t\t\t\ttitle : '提示'\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t} else if (rows.length == 1) {\r\n");
      out.write("\t\t\tvar node = storeType_datagrid.datagrid('getSelected');\r\n");
      out.write("\t\t\tvar d=$('<div/>').dialog({\r\n");
      out.write("\t\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeTypeManager/edit.action',\r\n");
      out.write("\t\t\t\twidth : 500,\r\n");
      out.write("\t\t\t\theight : 380,\r\n");
      out.write("\t\t\t\tmodal : true,\r\n");
      out.write("\t\t\t\ttitle : '编辑仓库类型',\r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$('#editstoreType').form('submit', {\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeType/edit.action',\r\n");
      ...
      out.write("\t\t\t\t\t$('#editStoreType').form('load', node);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction storeType_add() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar d=$('<div/>').dialog({\r\n");
      out.write("\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeTypeManager/add.action',\r\n");
      out.write("\t\t\twidth : 500,\r\n");
      out.write("\t\t\theight : 380,\r\n");
      out.write("\t\t\tmodal : true,\r\n");
      ...
      out.write("\t\t\t\t\t$('#addStoreType').form('submit', {\r\n");
      out.write("\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/storeType/add.action',\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(result) {\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar r = $.parseJSON(result);\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tmsg : r.msg\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstoreType_datagrid.datagrid('appendRow',r.data);\r\n");
      out.write("\t\t\t\t\t\t\t\t\td.dialog('destroy');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\telse if(r.status='404'){\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction storeType_search() {\r\n");
      out.write("\t\tstoreType_datagrid.datagrid('load',  serializeObject(storeType_searchForm));\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction storeType_cleanSearch() {\r\n");
      out.write("\t\tstoreType_datagrid.datagrid('load', {});\r\n");
      out.write("\t\tstoreType_searchForm.find('input').val('');\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t<table id=\"storeType_datagrid\"></table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</body>\r\n");
