 ...
 * Generated at: 2018-04-13 10:17:49 UTC
...
public final class supplierManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar supplier_searchForm;\r\n");
      out.write("\tvar editRow = undefined;\r\n");
      out.write("\tvar supplier_datagrid; \r\n");
      out.write("\t$(function() {\r\n");
      out.write("\t\tsupplier_searchForm = $('#supplier_searchForm').form();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\tsupplier_datagrid = $('#supplier_datagrid').datagrid({\r\n");
      out.write("\t\r\n");
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplier/list.action',\r\n");
      out.write("\t\t\ttitle : '供应商列表',\r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tsupplier_del();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, '-', {\r\n");
      out.write("\t\t\t\t\ttext : '修改',\r\n");
      out.write("\t\t\t\t\ticonCls : 'icon-edit',\r\n");
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tsupplier_edit();\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, '-', {\r\n");
      out.write("\t\t\t\t\ttext : '保存',\r\n");
      out.write("\t\t\t\t\ticonCls : 'icon-save',\r\n");
      ...
      out.write("\t\t\t\t\t\t\tsupplier_datagrid.datagrid('endEdit', editRow);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\t \r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tsupplier_datagrid.datagrid('unselectAll');\r\n");
      out.write("\t\t\t\t\t\tsupplier_datagrid.datagrid.datagrid('rejectChanges');\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      out.write("\tfunction supplier_del(){\r\n");
      out.write("\t\tvar rows = supplier_datagrid.datagrid('getSelections');\r\n");
      out.write("\t\tvar ids = [];\r\n");
      ...
      out.write("\t\t            }\r\n");
      out.write("\t\t    \t$.messager.confirm('询问', '您确定要删除【' + rows.length + '】个供应商？', function(b) {\t\t\t\t \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t    \t\tif (b) {\r\n");
      out.write("\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplier/delete.action?ids='+ids+'',\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t            var index = supplier_datagrid.datagrid('getRowIndex',copyRows[i]);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            supplier_datagrid.datagrid('deleteRow',index); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     supplier_datagrid.datagrid('reload');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//supplier_datagrid.datagrid('clearSelections'); //清空选中的行 \r\n");
      ...
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction supplier_edit() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar rows = supplier_datagrid.datagrid('getSelections');\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$.messager.show({\r\n");
      out.write("\t\t\t\tmsg : '只能择一个供应商进行编辑！您已经选择了【' + names.join(',') + '】' + rows.length + '个供应商',\r\n");
      out.write("\t\t\t\ttitle : '提示'\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t} else if (rows.length == 1) {\r\n");
      out.write("\t\t\tvar node = supplier_datagrid.datagrid('getSelected');\r\n");
      out.write("\t\t\tvar d=$('<div/>').dialog({\r\n");
      out.write("\t\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplierManager/edit.action',\r\n");
      out.write("\t\t\t\twidth : 500,\r\n");
      out.write("\t\t\t\theight : 380,\r\n");
      out.write("\t\t\t\tmodal : true,\r\n");
      out.write("\t\t\t\ttitle : '编辑供应商',\r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$('#editSupplier').form('submit', {\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplier/edit.action',\r\n");
      ...
      out.write("\t\t\t\t\t$('#editSupplier').form('load', node);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.show({\r\n");
      out.write("\t\t\t\tmsg : '请选择一个供应商类型进行编辑!',\r\n");
      out.write("\t\t\t\ttitle : '提示'\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction supplier_add() {\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar d=$('<div/>').dialog({\r\n");
      out.write("\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplierManager/add.action',\r\n");
      out.write("\t\t\twidth : 500,\r\n");
      out.write("\t\t\theight : 380,\r\n");
      out.write("\t\t\tmodal : true,\r\n");
      ...
      out.write("\t\t\t\t\t$('#addSupplier').form('submit', {\r\n");
      out.write("\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/supplier/add.action',\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(result) {\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar r = $.parseJSON(result);\r\n");
      out.write("\t\t\t\t\t\t \t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tmsg : r.msg\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//supplier_datagrid.datagrid('appendRow',r.data);\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsupplier_datagrid.datagrid('load',{});\r\n");
      out.write("\t\t\t\t\t\t\t\t\td.dialog('destroy');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\telse if(r.status='404'){\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction supplier_search() {\r\n");
      out.write("\t\tsupplier_datagrid.datagrid('load',  serializeObject(supplier_searchForm));\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction supplier_cleanSearch() {\r\n");
      out.write("\t\tsupplier_datagrid.datagrid('load', {});\r\n");
      out.write("\t\tsupplier_searchForm.find('input').val('');\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t<table id=\"supplier_datagrid\"></table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</body>\r\n");
