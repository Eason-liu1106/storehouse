 ...
 * Generated at: 2018-04-19 08:07:18 UTC
...
public final class userManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar user_searchForm;\r\n");
      out.write("\t\r\n");
      out.write("\tvar user_datagrid; \r\n");
      out.write("\t$(function() {\r\n");
      out.write("\t\tuser_searchForm = $('#user_searchForm').form();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tuser_datagrid = $('#user_datagrid').datagrid({\r\n");
      out.write("\t\r\n");
      out.write("\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}, {\r\n");
      out.write("\t\t\t\tfield : 'salt',\r\n");
      out.write("\t\t\t\ttitle : '盐',\r\n");
      out.write("\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\tsortable : true\r\n");
      out.write("\t\t\t} ,{\r\n");
      out.write("\t\t\t\tfield : 'roleIds',\r\n");
      out.write("\t\t\t\ttitle : '拥有角色ID',\r\n");
      out.write("\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t\thidden : true\r\n");
      out.write("\t\t\t}, {\r\n");
      out.write("\t\t\t\tfield : 'roleNames',\r\n");
      out.write("\t\t\t\ttitle : '拥有角色',\r\n");
      out.write("\t\t\t\twidth : 150,\r\n");
      out.write("\t\t\t},{\r\n");
      out.write("\t\t\t\tfield : 'locked',\r\n");
      out.write("\t\t\t\ttitle : '状态',\r\n");
      out.write("\t\t\t\twidth : 100,\r\n");
      out.write("\t\t\t\tsortable : true\r\n");
      out.write("\t\t\t} ] ],\r\n");
      ...
      out.write("\t\t\t\t\t\t\tuser_datagrid.datagrid('endEdit', editRow);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\t \r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\tuser_datagrid.datagrid('unselectAll');\r\n");
      out.write("\t\t\t\t\t\tuser_datagrid.datagrid.datagrid('rejectChanges');\r\n");
      ...
      out.write("\t\t            }\r\n");
      out.write("\t\t    \t$.messager.confirm('询问', '您确定要删除【' + rows.length + '】个管理员', function(b) {\t\t\t\t \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t    \t\tif (b) {\r\n");
      out.write("\t\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/delete.action?ids='+ids+'',\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t            var index = user_datagrid.datagrid('getRowIndex',copyRows[i]);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t            user_datagrid.datagrid('deleteRow',index); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t        }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t     user_datagrid.datagrid('reload');\r\n");
      out.write("\t\t\t\t\t\t\t\t\tuser_datagrid.datagrid('clearSelections'); //清空选中的行 \r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$.messager.show({\r\n");
      out.write("\t\t\t\tmsg : '只能择一个管理员进行编辑！您已经选择了【' + names.join(',') + '】' + rows.length + '个管理员',\r\n");
      out.write("\t\t\t\ttitle : '提示'\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t} else if (rows.length == 1) {\r\n");
      out.write("\t\t\tvar node = user_datagrid.datagrid('getSelected');\r\n");
      out.write("\t\t\tvar d=$('<div/>').dialog({\r\n");
      out.write("\t\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/userManager/edit.action',\r\n");
      out.write("\t\t\t\twidth : 500,\r\n");
      out.write("\t\t\t\theight : 380,\r\n");
      out.write("\t\t\t\tmodal : true,\r\n");
      out.write("\t\t\t\ttitle : '编辑管理员',\r\n");
      ...
      out.write("\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t$('#editUser').form('submit', {\r\n");
      out.write("\t\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/edit.action',\r\n");
      ...
      out.write("\t\t\t\t\t$('#editUser').form('load', node);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.show({\r\n");
      out.write("\t\t\t\tmsg : '请选择一个管理员进行编辑!',\r\n");
      out.write("\t\t\t\ttitle : '提示'\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\thref : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/userManager/add.action',\r\n");
      out.write("\t\t\twidth : 500,\r\n");
      out.write("\t\t\theight : 380,\r\n");
      out.write("\t\t\tmodal : true,\r\n");
      ...
      out.write("\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$('#addUser').form('submit', {\r\n");
      out.write("\t\t\t\t\t\turl : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/add.action',\r\n");
      out.write("\t\t\t\t\t\tsuccess : function(result) {\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tvar r = $.parseJSON(result);\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction user_search() {\r\n");
      out.write("\t\tuser_datagrid.datagrid('load',  serializeObject(user_searchForm));\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction user_cleanSearch() {\r\n");
      out.write("\t\tuser_datagrid.datagrid('load', {});\r\n");
      out.write("\t\tuser_searchForm.find('input').val('');\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t<table id=\"user_datagrid\"></table>\r\n");
      out.write("\t</div> \r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
